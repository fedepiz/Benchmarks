...
Tuple_float_float_float_float *p86 = malloc(sizeof(Tuple_float_float_float_float) * 10000);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i1 = 0; i1 < 10000; i1++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 10000/10000)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 10000/10000)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 10000/10000)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 10000/10000)]._3));

}
}
//code for parameter p102
Tuple_float_float_float_float *p102 = malloc(sizeof(Tuple_float_float_float_float) * 10000);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i3 = 0; i3 < 10000; i3++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 10000/10000)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 10000/10000)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 10000/10000)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 10000/10000)]._3));
...
//main invocation
Tuple_Tuple_float_float_float_float_Tuple_float_float_float_float *output = malloc(sizeof(Tuple_Tuple_float_float_float_float_Tuple_float_float_float_float) * 10000 * 1);
