...
void liftKernel(float* v__8, Tuple_float_float* v__10){ 
{
  /* Static local memory */
  /* Typed Value memory */
  /* Private Memory */
  /* map_seq */
  for (int v_i_7 = 0;v_i_7<50000;v_i_7 = (1 + v_i_7)){
    v__10[v_i_7] = blackScholesComp(v__8[v_i_7]);
  }
  /* end map_seq */
}}
...
//code for parameter p141
float *p141 = malloc(sizeof(float) * 50000);
//geerating array of type float
for(unsigned long i1 = 0; i1 < 50000; i1++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p141[(i1 * 50000/50000)]));
}
//main invocation
Tuple_float_float *output = malloc(sizeof(Tuple_float_float) * 50000);
struct timeval startTime;
gettimeofday(&startTime, NULL);
liftKernel( p141, output);
