...
Tuple_float_float_float_float *p86 = malloc(sizeof(Tuple_float_float_float_float) * 5000);
...
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 5000/5000)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 5000/5000)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 5000/5000)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 5000/5000)]._3));

}
}
//code for parameter p102
Tuple_float_float_float_float *p102 = malloc(sizeof(Tuple_float_float_float_float) * 5000);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i3 = 0; i3 < 5000; i3++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 5000/5000)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 5000/5000)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 5000/5000)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 5000/5000)]._3));
