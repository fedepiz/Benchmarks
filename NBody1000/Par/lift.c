...
Tuple_float_float_float_float *p78 = malloc(sizeof(Tuple_float_float_float_float) * 1000);
...
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p78[(i1 * 1000/1000)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p78[(i1 * 1000/1000)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p78[(i1 * 1000/1000)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p78[(i1 * 1000/1000)]._3));

}
}
//code for parameter p101
Tuple_float_float_float_float *p101 = malloc(sizeof(Tuple_float_float_float_float) * 1000);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i3 = 0; i3 < 1000; i3++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p101[(i3 * 1000/1000)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p101[(i3 * 1000/1000)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p101[(i3 * 1000/1000)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p101[(i3 * 1000/1000)]._3));
...
//main invocation
Tuple_Tuple_float_float_float_float_Tuple_float_float_float_float *output = malloc(sizeof(Tuple_Tuple_float_float_float_float_Tuple_float_float_float_float) * 1000 * 1);
