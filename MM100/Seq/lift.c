...
float *p242 = malloc(sizeof(float) * 100 * 100);
//geerating array of type float
for(unsigned long i2 = 0; i2 < 100; i2++){
for(unsigned long i3 = 0; i3 < 100; i3++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p242[(i2 * 100 * 100/100) + (i3 * 100 * 100/100/100)]));
}
}
//code for parameter p30
float *p30 = malloc(sizeof(float) * 100 * 100);
//geerating array of type float
for(unsigned long i6 = 0; i6 < 100; i6++){
for(unsigned long i7 = 0; i7 < 100; i7++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p30[(i6 * 100 * 100/100) + (i7 * 100 * 100/100/100)]));
}
}
