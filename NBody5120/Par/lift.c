...
Tuple_float_float_float_float *p88 = malloc(sizeof(Tuple_float_float_float_float) * 5120);
...
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p88[(i1 * 5120/5120)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p88[(i1 * 5120/5120)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p88[(i1 * 5120/5120)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p88[(i1 * 5120/5120)]._3));

}
}
//code for parameter p243
Tuple_float_float_float_float *p243 = malloc(sizeof(Tuple_float_float_float_float) * 5120);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i3 = 0; i3 < 5120; i3++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p243[(i3 * 5120/5120)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p243[(i3 * 5120/5120)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p243[(i3 * 5120/5120)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p243[(i3 * 5120/5120)]._3));
