...
void liftKernel(float* v__5, Tuple_float_float* v__7){ 
{
  ...
  /* Private Memory */
  /* map_seq */
  for (int v_i_4 = 0;v_i_4<12800;v_i_4 = (1 + v_i_4)){
...
float *p176 = malloc(sizeof(float) * 12800);
//geerating array of type float
for(unsigned long i1 = 0; i1 < 12800; i1++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p176[(i1 * 12800/12800)]));
}
//main invocation
Tuple_float_float *output = malloc(sizeof(Tuple_float_float) * 12800);
