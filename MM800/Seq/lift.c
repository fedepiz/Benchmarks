...
float *p242 = malloc(sizeof(float) * 800 * 800);
//geerating array of type float
for(unsigned long i2 = 0; i2 < 800; i2++){
for(unsigned long i3 = 0; i3 < 800; i3++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p242[(i2 * 800 * 800/800) + (i3 * 800 * 800/800/800)]));
}
}
//code for parameter p30
float *p30 = malloc(sizeof(float) * 800 * 800);
//geerating array of type float
for(unsigned long i6 = 0; i6 < 800; i6++){
for(unsigned long i7 = 0; i7 < 800; i7++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p30[(i6 * 800 * 800/800) + (i7 * 800 * 800/800/800)]));
}
}
