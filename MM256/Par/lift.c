...
float *p174 = malloc(sizeof(float) * 256 * 256);
//geerating array of type float
for(unsigned long i2 = 0; i2 < 256; i2++){
for(unsigned long i3 = 0; i3 < 256; i3++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p174[(i2 * 256 * 256/256) + (i3 * 256 * 256/256/256)]));
}
}
//code for parameter p10
float *p10 = malloc(sizeof(float) * 256 * 256);
//geerating array of type float
for(unsigned long i6 = 0; i6 < 256; i6++){
for(unsigned long i7 = 0; i7 < 256; i7++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p10[(i6 * 256 * 256/256) + (i7 * 256 * 256/256/256)]));
}
}
