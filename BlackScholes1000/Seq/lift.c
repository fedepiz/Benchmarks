...
void liftKernel(float* v__4, Tuple_float_float* v__6){ 
{
  ...
  /* Private Memory */
  /* map_seq */
  for (int v_i_3 = 0;v_i_3<1000;v_i_3 = (1 + v_i_3)){
...
float *p176 = malloc(sizeof(float) * 1000);
//geerating array of type float
for(unsigned long i1 = 0; i1 < 1000; i1++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p176[(i1 * 1000/1000)]));
}
//main invocation
Tuple_float_float *output = malloc(sizeof(Tuple_float_float) * 1000);
