...
Tuple_float_float_float_float *p86 = malloc(sizeof(Tuple_float_float_float_float) * 12800);
...
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 12800/12800)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 12800/12800)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 12800/12800)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 12800/12800)]._3));

}
}
//code for parameter p102
Tuple_float_float_float_float *p102 = malloc(sizeof(Tuple_float_float_float_float) * 12800);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i3 = 0; i3 < 12800; i3++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 12800/12800)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 12800/12800)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 12800/12800)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 12800/12800)]._3));
