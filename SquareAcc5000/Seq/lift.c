...
void liftKernel(float* v__12, float* v__15, float* v__19){ 
{
  ...
  for (int v_i_9 = 0;v_i_9<5000;v_i_9 = (1 + v_i_9)){
    v__15[v_i_9] = square(v__12[v_i_9]);
  }
  /* end omp_map */
  /* reduce_seq */
  for (int v_i_10 = 0;v_i_10<5000;v_i_10 = (1 + v_i_10)){
...
float *p247 = malloc(sizeof(float) * 5000);
//geerating array of type float
for(unsigned long i1 = 0; i1 < 5000; i1++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p247[(i1 * 5000/5000)]));
}
//Code for intermediate parameters
float *v__15 = malloc(sizeof(float) * 5000);
//main invocation
