...
void liftKernel(float* v__5, Tuple_float_float* v__7){ 
{
  ...
  /* Private Memory */
  /* map_seq */
  for (int v_i_4 = 0;v_i_4<1280;v_i_4 = (1 + v_i_4)){
...
float *p176 = malloc(sizeof(float) * 1280);
//geerating array of type float
for(unsigned long i1 = 0; i1 < 1280; i1++){
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p176[(i1 * 1280/1280)]));
}
//main invocation
Tuple_float_float *output = malloc(sizeof(Tuple_float_float) * 1280);
