...
void liftKernel(Tuple_float_float_float_float* v__12, Tuple_float_float_float_float* v__13, float v__14, float v__15, Tuple_Tuple_float_float_float_float_Tuple_float_float_float_float* v__23){ 
{
  ...
  for (int v_i_9 = 0;v_i_9<1280;v_i_9 = (1 + v_i_9)){
    ...
    v__18 = v_tmp_35;
    /* reduce_seq */
    for (int v_i_10 = 0;v_i_10<1280;v_i_10 = (1 + v_i_10)){
...
Tuple_float_float_float_float *p86 = malloc(sizeof(Tuple_float_float_float_float) * 1280);
...
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 1280/1280)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 1280/1280)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 1280/1280)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p86[(i1 * 1280/1280)]._3));

}
}
//code for parameter p102
Tuple_float_float_float_float *p102 = malloc(sizeof(Tuple_float_float_float_float) * 1280);
//geerating array of type Tuple_float_float_float_float
for(unsigned long i3 = 0; i3 < 1280; i3++){
//reading tuple of t ype Tuple(float, float, float, float)
{
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 1280/1280)]._0));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 1280/1280)]._1));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 1280/1280)]._2));
inputData = strtok(NULL, "_"); sscanf(inputData,"%f",&(p102[(i3 * 1280/1280)]._3));
